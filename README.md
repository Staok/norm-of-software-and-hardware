...
-   软件框架，规范化。[1 关于 C & MCU 的本人规范 请戳这里](https://github.com/Staok/coding-style-and-more)、[2 关于 HDL & FPGA 的本人规范 请戳这里](https://github.com/Staok/HDL-FPGA-study-and-norms)
-   硬件模块，规范化。[本人规范 请戳这里](https://github.com/Staok/thoughs-about-hardware-design)。
